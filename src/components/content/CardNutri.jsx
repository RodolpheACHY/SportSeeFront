...
const CardNutri = ({ icon, value, unit, label, bgColor, size, radius, iconSize }) => {
  return (
    <div className={styles.cardNutri}>
        <div className={styles['cardNutri__icon-container']}>
            <IconWrapper IconComponent={icon} bgColor={bgColor} size={size} radius={radius} iconSize={iconSize} />
        </div>
